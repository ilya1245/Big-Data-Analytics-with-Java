 ...
 */
public class SentimentalAnalysisSVM {
    //
    public static void main(String[] args) {
        LogManager.getLogger("org").setLevel(Level.OFF);
        LogManager.getLogger("breeze").setLevel(Level.OFF);
        ...
        LinearSVC linearSVM = new LinearSVC().setFeaturesCol("features").setPredictionCol("predictions");

        Pipeline p = new Pipeline();

        p.setStages(new PipelineStage[]{tokenizer, stopWrdRem, hashingTF, idf, linearSVM});
